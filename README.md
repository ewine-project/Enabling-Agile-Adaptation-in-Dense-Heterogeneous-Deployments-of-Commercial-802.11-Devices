...
system [1] on top of commercial 802.11ac compatible hardware. The developed system builds on the
open-source ath10k driver [2] for 802.11ac chipsets of Qualcomm to deliver an abstraction of open
...
background services over the OpenWRT [3] embedded Linux, to continuously estimate the link
